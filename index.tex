...
%\begin{left}
%
%	\includegraphics[scale=0.5]{vessel_config.pdf} \label{fig:vessel_config}\\
%	
%	\includegraphics[width=0.5 \textwidth]{vessel_doors.pdf} \label{fig:doors} \\
%	
%	\includegraphics[width=0.5 \textwidth]{vessel_door_tighten.pdf} \label{fig:bolt_tight} \\
%	
%\end{left}
\begin{figure} \includegraphics[scale=1]{vessel_config.eps} \end{figure}
%\the\dimexpr .5\textwidth\relax
\begin{figure}
%	\centering
